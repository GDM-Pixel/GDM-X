        ...
        <div className="overflow-x-clip">
            <div className="container wide xs:w-full overflow-x-clip">
                <div className="grid lg:grid-cols-6 md:grid-cols-3 xs:grid-cols-2 gap-6 items-center mb-6">
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'UXUI' ? 'active' : ''}`} onClick={() => setActiveTab('UXUI')}>
                        ...
                        UX / UI</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Devfrontend' ? 'active' : ''}`} onClick={() => setActiveTab('Devfrontend')}>
                        <svg width="45" height="40" viewBox="0 0 45 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Dev Front-End</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Responsive' ? 'active' : ''}`} onClick={() => setActiveTab('Responsive')}>
                        ...
                        Responsive</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Surmesure' ? 'active' : ''}`} onClick={() => setActiveTab('Surmesure')}>
                        ...
                        Sur mesure</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Cms' ? 'active' : ''}`} onClick={() => setActiveTab('Cms')}>
                        ...
                        CMS</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Ecommerce' ? 'active' : ''}`} onClick={() => setActiveTab('Ecommerce')}>
                        <svg width="46" height="40" viewBox="0 0 46 40" fill="none" xmlns="http://www.w3.org/2000/svg">
