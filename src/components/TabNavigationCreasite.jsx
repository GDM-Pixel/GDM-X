...
import UXUI from './TabNav/Creation-Site/UXUI.jsx';
import Devfrontend from './TabNav/Creation-Site/DevFront-End.jsx';
import Responsive from './TabNav/Creation-Site/Responsive.jsx';
import Surmesure from './TabNav/Creation-Site/Surmesure.jsx';
import Cms from './TabNav/Creation-Site/CMS.jsx';
import Ecommerce from './TabNav/Creation-Site/E-Commerce.jsx';
        ...
        <div className="overflow-x-clip">
            <div className="container wide xs:w-full overflow-x-clip">
                <div className="grid lg:grid-cols-6 md:grid-cols-3 xs:grid-cols-2 gap-6 items-center mb-6">
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'UXUI' ? 'active' : ''}`} onClick={() => setActiveTab('UXUI')} onMouseEnter={() => preloadImage('/img/uxui.webp')}>
                        ...
                        UX / UI</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Devfrontend' ? 'active' : ''}`} onClick={() => setActiveTab('Devfrontend')} onMouseEnter={() => preloadImage('/img/devfrontend.webp')}>
                        <svg width="45" height="40" viewBox="0 0 45 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Dev Front-End</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Responsive' ? 'active' : ''}`} onClick={() => setActiveTab('Responsive')} onMouseEnter={() => preloadImage('/img/responsive.webp')}>
                        ...
                        Responsive</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Surmesure' ? 'active' : ''}`} onClick={() => setActiveTab('Surmesure')} onMouseEnter={() => preloadImage('/img/surmesure.webp')}>
                        ...
                        Sur mesure</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Cms' ? 'active' : ''}`} onClick={() => setActiveTab('Cms')} onMouseEnter={() => preloadImage('/img/cms.webp')}>
                        ...
                        CMS</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Ecommerce' ? 'active' : ''}`} onClick={() => setActiveTab('Ecommerce')} onMouseEnter={() => preloadImage('/img/ecommerce2.webp')}>
                        <svg width="46" height="40" viewBox="0 0 46 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="tab-content relative">
                <CSSTransition in={activeTab === 'UXUI'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <UXUI />
                </CSSTransition>

                <CSSTransition in={activeTab === 'Devfrontend'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Devfrontend />
                </CSSTransition>
                ...
                <CSSTransition in={activeTab === 'Responsive'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Responsive />
                </CSSTransition>

                <CSSTransition in={activeTab === 'Surmesure'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Surmesure />
                </CSSTransition>

                <CSSTransition in={activeTab === 'Cms'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Cms />
                </CSSTransition>
