...
function TabSliderSEM() {
    const [activeTabSEM, setActiveTabSEM] = useState('Analyse');
        ...
        <div className="overflow-x-clip">
            <div className="overflow-x-clip">
                <div className="grid lg:grid-cols-4 md:grid-cols-2 xs:grid-cols-2 gap-6 items-center mb-6">
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEM === 'Analyse' ? 'activeSEM' : ''}`} onClick={() => setActiveTabSEM('Analyse')} onMouseEnter={() => preloadImage('/img/team-charts-audit-sem.webp')}>
                        ...
                        Analyse</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEM === 'Suivi' ? 'activeSEM' : ''}`} onClick={() => setActiveTabSEM('Suivi')} onMouseEnter={() => preloadImage('/img/team-audit-charts.webp')}>
                       <svg xmlns="http://www.w3.org/2000/svg" height="32" width="40" viewBox="0 0 640 512"><path d="M334.1 31.1l-14.3-28-14.3 28L282.8 75.8l-49.5 7.9-30.9 4.9 22.1 22.2 35.4 35.5-7.8 49.6-4.9 31 27.9-14.2 44.7-22.7 44.7 22.7 27.9 14.2-4.9-31-7.8-49.6 35.4-35.5 22.1-22.2-30.9-4.9-49.5-7.9L334.1 31.1zM307.6 97.6l12.2-24 12.2 24 3.7 7.3 8 1.3 26.6 4.2-19 19.1-5.7 5.8 1.3 8 4.2 26.6-24-12.2-7.3-3.7-7.3 3.7-24 12.2 4.2-26.6 1.3-8-5.7-5.8-19-19.1 26.6-4.2 8-1.3 3.7-7.3zM224 256v32 32V480v32h32H384h32V480 384 352 288 256H384 256 224zM384 480H256V288H384V480zM0 320v32V480v32H32 160h32V480 352 320H160 32 0zM160 480H32V352H160V480zm320-64H608v64H480V416zm160-32H608 480 448v32 64 32h32H608h32V480 416 384z"/></svg>
                        Suivi</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEM === 'ABTesting' ? 'activeSEM' : ''}`} onClick={() => setActiveTabSEM('ABTesting')} onMouseEnter={() => preloadImage('/img/split-testing.webp')}>
                        ...
                        AB-Testing</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEM === 'Behaviour' ? 'activeSEM' : ''}`} onClick={() => setActiveTabSEM('Behaviour')} onMouseEnter={() => preloadImage('/img/heat-optimisation.webp')}>
            ...
            <div className="tab-content relative">
                <CSSTransition in={activeTabSEM === 'Analyse'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Analyse />
                </CSSTransition>

                <CSSTransition in={activeTabSEM === 'Suivi'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Suivi />
                </CSSTransition>

                <CSSTransition in={activeTabSEM === 'ABTesting'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <ABTesting />
                </CSSTransition>

                <CSSTransition in={activeTabSEM === 'Behaviour'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Behaviour />
                </CSSTransition>
    ...
    .tab.activeSEM {background-color:#D62246;color:white;transition:300ms ease all;border-style:solid;}
    .tab.activeSEM svg {fill:white;}
