        ...
        <div className="overflow-x-clip">
            <div className="overflow-x-clip">
                <div className="grid lg:grid-cols-5 md:grid-cols-3 xs:grid-cols-2 gap-6 items-center mb-6">
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEA === 'Strategie' ? 'activeSEA' : ''}`} onClick={() => setActiveTabSEA('Strategie')}>
                        ...
                        Strategie</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEA === 'Annonces' ? 'activeSEA' : ''}`} onClick={() => setActiveTabSEA('Annonces')}>
                        ...
                        Annonces</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEA === 'Performances' ? 'activeSEA' : ''}`} onClick={() => setActiveTabSEA('Performances')}>
                        ...
                        Performances</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEA === 'Gestion' ? 'activeSEA' : ''}`} onClick={() => setActiveTabSEA('Gestion')}>
                        ...
                        Gestion</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEA === 'Retargeting' ? 'activeSEA' : ''}`} onClick={() => setActiveTabSEA('Retargeting')}>
