        ...
        <div className="overflow-x-clip">
            <div className="container wide xs:w-full overflow-x-clip">
                <div className="grid lg:grid-cols-5 md:grid-cols-3 xs:grid-cols-2 gap-6 items-center mb-6">
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Strategie' ? 'active' : ''}`} onClick={() => setActiveTab('Strategie')}>
                        ...
                        Strategie</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Annonces' ? 'active' : ''}`} onClick={() => setActiveTab('Annonces')}>
                        ...
                        Annonces</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Performances' ? 'active' : ''}`} onClick={() => setActiveTab('Performances')}>
                        ...
                        Performances</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Gestion' ? 'active' : ''}`} onClick={() => setActiveTab('Gestion')}>
                        ...
                        Gestion</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTab === 'Retargeting' ? 'active' : ''}`} onClick={() => setActiveTab('Retargeting')}>
            ...
            <div className="tab-content relative">
                <CSSTransition in={activeTab === 'Strategie'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Strategie />
                </CSSTransition>

                <CSSTransition in={activeTab === 'Annonces'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Annonces />
                </CSSTransition>

                <CSSTransition in={activeTab === 'Performances'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Performances />
                </CSSTransition>

                <CSSTransition in={activeTab === 'Gestion'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Gestion />
                </CSSTransition>

                <CSSTransition in={activeTab === 'Retargeting'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Retargeting />
                </CSSTransition>
