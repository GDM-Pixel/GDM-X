    ...
    return (
        <div className="flex lg:flex-row-reverse flex-col container max-w-5xl gap-6">
            <div className="col lg:w-1/2 tabslidercontent flex flex-col justify-center">
                ...
                <a className="cta blue self-start" data-image-src="/img/hero-maintenance.webp" href="/maintenance-depannage/">En savoir plus</a>
            </div>
            <div className="col lg:w-1/2 flex flex-col justify-center"> <img className="rounded-md" src="/img/maintenance.webp" alt="Maintenance de site web" /></div>
        </div>
    );
}
