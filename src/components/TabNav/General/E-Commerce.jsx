    ...
    return (
        <div className="flex flex-row-reverse container max-w-5xl gap-6">
            <div className="col w-1/2 tabslidercontent flex flex-col justify-center">
                ...
                <a className="cta blue self-start" href="/creer-ecommerce/">En savoir plus</a>
            </div>
            <div className="col w-1/2 flex flex-col justify-center"> <img className="rounded-md" src="/img/ecommerce.webp" alt="Création de site E-commerce" /></div>
        </div>
    );
}
