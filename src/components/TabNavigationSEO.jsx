...
function TabSliderSEO() {
    const [activeTabSEO, setActiveTabSEO] = useState('Audit');
        ...
        <div className="overflow-x-clip">
            <div className="overflow-x-clip">
                <div className="grid lg:grid-cols-6 md:grid-cols-3 xs:grid-cols-2 gap-6 items-center mb-6">
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Audit' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Audit')} onMouseEnter={() => preloadImage('/img/audit-seo.webp')}>
                        ...
                        Audit</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'ONPage' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('ONPage')} onMouseEnter={() => preloadImage('/img/copywriting.webp')}>
                        ...
                        On Page</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Contenus' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Contenus')} onMouseEnter={() => preloadImage('/img/contenus.webp')}>
                        ...
                        Contenus</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Netlinking' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Netlinking')} onMouseEnter={() => preloadImage('/img/netlinking.webp')}>
                        ...
                        Netlinking</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Veille' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Veille')} onMouseEnter={() => preloadImage('/img/veille.webp')}>
                        ...
                        Veille</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Reporting' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Reporting')} onMouseEnter={() => preloadImage('/img/analytics.webp')}>
            ...
            <div className="tab-content relative">
                <CSSTransition in={activeTabSEO === 'Audit'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Audit />
                </CSSTransition>

                <CSSTransition in={activeTabSEO === 'ONPage'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <ONPage />
                </CSSTransition>

                <CSSTransition in={activeTabSEO === 'Reporting'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Reporting />
                </CSSTransition>

                <CSSTransition in={activeTabSEO === 'Contenus'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Contenus />
                </CSSTransition>

                <CSSTransition in={activeTabSEO === 'Netlinking'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Netlinking />
                </CSSTransition>

                <CSSTransition in={activeTabSEO === 'Veille'} timeout={{ enter: 600, exit: 300 }} classNames="slidetransit" unmountOnExit>
                    <Veille />
                </CSSTransition>
    ...
    .tab.activeSEO {background-color:#D62246;color:white;transition:300ms ease all;border-style:solid;}
    .tab.activeSEO svg {fill:white;}
