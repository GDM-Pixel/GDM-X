        ...
        <div className="overflow-x-clip">
            <div className="overflow-x-clip">
                <div className="grid lg:grid-cols-6 md:grid-cols-3 xs:grid-cols-2 gap-6 items-center mb-6">
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Audit' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Audit')}>
                        ...
                        Audit</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'ONPage' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('ONPage')}>
                        ...
                        On Page</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Contenus' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Contenus')}>
                        ...
                        Contenus</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Netlinking' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Netlinking')}>
                        ...
                        Netlinking</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Veille' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Veille')}>
                        ...
                        Veille</div>
                    <div className={`tab p-6 border border-1 text-center ${activeTabSEO === 'Reporting' ? 'activeSEO' : ''}`} onClick={() => setActiveTabSEO('Reporting')}>
